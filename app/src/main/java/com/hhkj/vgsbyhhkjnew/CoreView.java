...
public class CoreView extends View implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public void initData() {
        ...
        initBoundary(0, 0, shapes, xList, yList, false);
        ...
        for (Shape shape : shapeLists) {
            ...
            switch (shape.getType()) {//0.组合
                ...
                case 2://2.多边形
                    ...
                    canvas.rotate(shape.getRotateAngle(), p.getX(), p.getY());
                ...
                case 3://3.矩形
                    ...
                    canvas.rotate(shape.getRotateAngle(), p1.getX(), p1.getY());
                ...
                case 4://4.椭圆
                    ...
                    canvas.rotate(shape.getRotateAngle(), p1ellipseGeometry.getX(), p1ellipseGeometry.getY());
        ...
        for (Shape shape : shapeLists) {
            switch (shape.getType()) {//0.组合
                case 0:
                    ...
                    //计算组合元素的旋转中心
                    Point pr = playRectCenterPoint(shape.area);
                    shape.setRotateCenterbygroup(pr);
        ...
        for (Shape shape : shapeLists) {
            switch (shape.getType()) {//0.组合
                case 0:
                    ...
                    float shapey1 = (float) Collections.min(myList);
                    float shapex2 = (float) Collections.max(mxList);
                    float shapey2 = (float) Collections.max(myList);
                    shape.area = new Float[4];
                    shape.area[0] = shapex1;
                    shape.area[1] = shapey1;
                    shape.area[2] = shapex2;
